...
begin
   if CounterEditorMode = 10 then begin
     ...
     if CounterEditorMode >= 5 then begin
       ToastMessage.Toast(tpInfo,'DEVELOPER',IntToStr(10-CounterEditorMode) + ' Click to Developer Mode!!    ');
     end;
   ...
   if OnEditorMode then begin
     ...
     ToastMessage.Toast(tpInfo,'DEVELOPER','You Are Now In Developer Mode');
